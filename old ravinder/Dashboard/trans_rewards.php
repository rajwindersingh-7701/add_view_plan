...
<div class="col-lg-9">
    ...
    <div class="profile-content">
        ...
        <div class="transaction-area">
                    ...
                    $direct_get = "SELECT count(id) as directs FROM `user` where sponser_by='".$user['user_id']."'";
                    $querydirects = mysqli_query($db, $direct_get);  
                    $dataQuerydirects = mysqli_fetch_array($querydirects);
                    // $dataQuerydirects['directs'] = 315;
                    $k = 1;
    ...
    <!--                                <span class="date">17</span>
                            ...
                            <div class="col cs1">
                                ...
                                if($dataQuerydirects['directs'] < $reward[$k]['directs']){
                                    // if($dataQuery['directs'])
                                    $_direct = ($dataQuerydirects['directs']-$reward[$k-1]['directs']);
                                    if($_direct > 0){
                                        echo ($reward[$k]['directs'] - $dataQuerydirects['directs']);
                                    }else{
                                        echo $dataQuery['direct'];
                                    }
                                }else{
                                    echo '0';
                                }
                                //$dataQuery['direct']; ?></span>
                            </div>
                            <div class="col cs1" >
