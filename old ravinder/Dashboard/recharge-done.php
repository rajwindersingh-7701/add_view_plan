...
<!-- Mirrored from demo.themeies.com/probill/recharge-done.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Apr 2020 06:40:02 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-md-12 profile-content ">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="recharge-done.html" >Done</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="five" role="tabpanel" aria-labelledby="five-tab">
                                <div class="done my-5">
                                    ...
                                    <p>Your payment $8 has been successfully<br>
                                        to receive <b>+1 408 7094360</b> Mobile Operator.</p>
                                        <div class="invoice-option text-center">
                                            ...
                                            <p class="mt-4 mb-0"><a href="#" class="btn btn-default">Make another Recharge</a></p>
                                        </div>
                                </div>
                            </div>
                        </div>
