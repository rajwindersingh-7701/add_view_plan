...
$query = "select * from `googleadd` where status=1";
                ...
                <div class="box-header with-border">
                    ...
                    <div style="text-align: center;">
                        ...
                        if ($dta[$page]['url'] != '') {
                            ...
                            <?php
                        } else if ($dta[$page]['button'] != '') {
                            ?>
                            <a href=" <?php echo $dta[$page]['button']; ?>"> <img width="100%" autoplay height="340" src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4NrXu45KYheOoeBGj0tCMj7jWLDWVZTTRCA&usqp=CAU" frameborder="0"></a>
                            <a href=" <?php echo $dta[$page]['button']; ?>" class="btn btn-default">Open link for task</a>
                            <?php
                        } else {
                            ?>
                            <img src="<?php echo $dta[$page]['image']; ?>" class="ad-show" style="max-height: 300px; width: auto;margin: 0 auto;"> 
                        <?php } ?>
    ...
    <script>
        ...
        function countdown() {
            ...
            if (timeLeft == 2) {
                ...
                document.getElementById('next').innerHTML = "<a class='btn btn-default' href='ad_task_1.php?p=<?php echo $page + 1; ?>'>" + btn + "</a>";
                document.getElementById('next1').innerHTML = "<a class='btn btn-default' href='ad_task_1.php?p=<?php echo $page + 1; ?>'>" + btn + "</a>";
