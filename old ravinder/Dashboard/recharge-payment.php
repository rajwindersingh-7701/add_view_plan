...
<!-- Mirrored from demo.themeies.com/probill/recharge-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Apr 2020 06:39:59 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!--Title -->
    <title>Probill - Multipurpose Recharge & Billing Payment System</title>
    ...
    <header class="header">
        ...
        <nav class="">
            <div class="nav-header">
                <a href="home-01.html" class="brand"><i class="ti-eraser">Probill</i><span></span></a>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-md-12 profile-content ">
                        <ul class="nav nav-pills">                    
                            <li class="nav-item">
                                <a class="nav-link" href="recharge-order.html">Order</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="recharge-summary.html">Summary</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="recharge-payment.html">Payment</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="pills-tabContent">                            
                            ...
                            <div class="tab-pane fade show active" id="four" role="tabpanel" aria-labelledby="four-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="exampleInputEmail09" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail10">Expiration Date</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail10" placeholder="MM / YY">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail11">Cvv</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail11" placeholder="CVC">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail12">Full Name</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail12" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="credit-card">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail05">Street Address</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail05" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail06">City</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail06" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail07">Country</label>
                                                    <input type="email" class="form-control" id="exampleInputEmail07" placeholder="Country">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="savecard">Save my card Details.</label>
                                </div>
                                <ul class="pager my-5">
                                    <li><a href="recharge-summary.html" class="btn btn-default "><i class="fas fa-chevron-left"></i> Back</a></li>
                                    <li><a href="recharge-done.html" class="btn btn-default "> Next <i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget-navigation">
                            <h4 class="widget-title">About Probill</h4>
        ...
        <div class="foo-btm">
            <div class="container">
                <p class="copyright">Copyright © <script>
                    ...
                    </script> <i class="ti-heart"></i> <a href="#">themeies.com</a>. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- Footer end -->
        ...
        <div class="brpln open">
            ...
            <div class="outerblock greybgdark bg-offwhite">
                <form class="row">
                    ...
                    <div class="col-md-1">
                        <!-- <a class="btn btn-primary btn-block" href="recharge-order-summary.html"><i class="fas fa-search"></i></a> -->
                    </div>
                </form>
...
<!-- Mirrored from demo.themeies.com/probill/recharge-payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Apr 2020 06:40:02 GMT -->
</html>