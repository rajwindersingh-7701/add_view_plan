    ...
    <div class="side-menu center">
        ...
        <div class="inner-wrapper justify-content-center">
            <div class="col-md-12 text-center">
                <a href="javascript:void(0)" class="logo-full mb-4"><img src="img/gm.png" alt=""></a>
            </div>
            ...
            <ul><!-- SLIDE  -->
                ...
                <li data-index="rs-36" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption color-yellow"
                         ...
                         style="z-index: 10; min-width: 556px; max-width: 556px; white-space: nowrap; font-size: 60px; line-height: 75px; font-weight: 300; letter-spacing: 0px;font-family: 'Montserrat', sans-serif;">Welcome To</div>
                    ...
                    <div class="tp-caption color-black"
                         ...
                         style="z-index: 10; min-width: 556px; max-width: 556px; white-space: nowrap; font-weight: 700; letter-spacing: 0px;font-family: 'Montserrat', sans-serif;"><div id="js-rotating">Grow Money</div> </div>
                    ...
                    <div class="tp-caption color-black"
                         ...
                         style="z-index: 10; min-width: 650px; max-width: 650px; white-space: nowrap; font-weight: 400; letter-spacing: 0px;font-family: 'Source Sans Pro', sans-serif;">GrowMoney is a unique platform which provides income to their users with video ads watching. Users can earn great income by spending their time on our platform and watching video ads. On Growmoney, users can spend their free time and earn great income from that time.
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-slideloop"  data-easing="Power0.easeInOut" data-speed="12" data-xs="0" data-xe="60" data-ys="100" data-ye="60"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape1.png" alt="" data-ww="['51px','51px','51px','51px']" data-hh="['52px','52px','52px','52px']"  data-no-retina> </div></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-slideloop"  data-easing="Power0.easeInOut" data-speed="12" data-xs="0" data-xe="-50" data-ys="50" data-ye="20"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape2.png" alt="" data-ww="['50px','50px','50px','50px']" data-hh="['14px','14px','14px','14px']"  data-no-retina> </div></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-rotate"  data-easing="Power0.easeIn" data-startdeg="0" data-enddeg="360" data-speed="15" data-origin="50% 50%"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape3.png" alt="" data-ww="['67px','67px','67px','67px']" data-hh="['69px','69px','69px','69px']" data-no-retina> </div></div>
                            ...
                            <div class="animated-wrap slider-social icon-small">
                                <div class="animated-element icon-box-small bg-pink-two instagram-bg-hvr d-flex justify-content-center align-items-center">
                                    <a class="instagram-text-hvr" href="javascript:void(0);">
                                        <i class="fa fa-instagram font-16" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="animated-wrap slider-social icon-small">
                                <div class="animated-element icon-box-large-two bg-yellow twitter-bg-hvr d-flex justify-content-center align-items-center">
                                    <a class="twitter-text-hvr" href="javascript:void(0);">
                                        <i class="fa fa-twitter font-20" aria-hidden="true"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rs-looped rs-slideloop"  data-easing="Power0.easeInOut" data-speed="12" data-xs="0" data-xe="0" data-ys="-10" data-ye="60">
                            <div class="animated-wrap slider-social icon-small">
                                ...
                                <a class="facebook-text-hvr" href="javascript:void(0);">
                                    <i class="fa fa-facebook-f font-20" aria-hidden="true"></i>
                                </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-slideloop"  data-easing="Power0.easeInOut" data-speed="12" data-xs="0" data-xe="0" data-ys="10" data-ye="-50"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape4.png" alt="" data-ww="['24px','24px','24px','24px']" data-hh="['87px','87px','87px','87px']"  data-no-retina> </div></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="12" data-ys="-40" data-ye="40" data-xs="0" data-xe="20"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape5.png" alt="" data-ww="['44px','44px','44px','44px']" data-hh="['87px','87px','87px','87px']"  data-no-retina> </div></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-wave" data-speed="12" data-angle="90" data-radius="12px" data-origin="0% 0%"><img src="https://megaone.acrothemes.com/creative-studio/img/slider-shape6.png" alt="" data-ww="['44px','44px','44px','44px']" data-hh="['87px','87px','87px','87px']"  data-no-retina> </div></div>
                    ...
                    <div class="tp-caption tp-resizeme"
                         ...
                         style="z-index: 1;">
                        <div class="rs-looped rs-slideloop"  data-easing="Power0.easeInOut" data-speed="30" data-xs="-90" data-xe="90" data-ys="0" data-ye="20"><img src="https://megaone.acrothemes.com/creative-studio/img/arrows.png" alt="" data-ww="['97px','97px','97px','97px']" data-hh="['98px','98px','98px','98px']"  data-no-retina> </div></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 pr-5 mb-5 mb-lg-0 wow fadeInLeft">
                ...
                <img src="img/abt-img.jpg" class="about-img-small position-relative w-100" alt="">
            </div>
            <div class="col-lg-6 pl-6">
                <div class="main-title text-lg-left offset-md-1 mb-0 wow fadeInUp" data-wow-delay="300ms">
                    <h5 class="wow fadeInUp" data-wow-delay="300ms"> How Grow Money helps users to earn money</h5>
                    <h2 class="wow fadeInUp font-weight-light" data-wow-delay="400ms">With Grow Money users can earn<span class="color-pink">  a great amount from their free time.
</span></h2>
                    <p class="pb-4 wow fadeInUp" data-wow-delay="500ms">At present, Everybody spends a lot of time on social media for free. Grow Money is a unique platform that provides all content like another social media platform and also provides a great income to their users. With this platform, users can earn a sufficient income with watching some ads. It’s a unique income source for users.
</p>

                    <ul class="pb-5 text-left wow fadeInUp" data-wow-delay="600ms">
                    <li>It has multiple levels of Income.</li>
                      <li>Users can earn with referrals also.</li>
                        <li>It provides income from our free or wasted time.</li>
                    </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-title wow fadeIn" data-wow-delay="300ms">
                    <h2>Drive more <span class="color-pink">organic traffic</span> <br><span class="color-blue"> to your website.</span></h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="about-box mb-5 mb-lg-0 mx-auto bg-blue">
                    <span class="pro-step d-inline-block color-white"><i class="fa fa-facebook"></i></span>
                    <h5 class="font-weight-500 color-white mt-25px mb-15px text-capitalize">Facebook Advertising</h5>
                    <p class="font-weight-light color-white">Grow Money Helps to advertise your business on Facebook with advertisements. You just need to provide your business details to Grow Money and purchase our plan.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="about-box mb-5 mb-lg-0 mx-auto bg-yellow">
                    <span class="pro-step d-inline-block color-white"><i class="fa fa-youtube"></i></span>
                    <h5 class="font-weight-500 color-white mt-25px mb-15px">Youtube Advertising</h5>
                    <p class="font-weight-light color-white">Grow Money also advertisements for your business on youtube at targeted areas. You only need to select a plan and provide your business information to us.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-12">
                <div class="about-box mb-0 mx-auto bg-pink">
                    <span class="pro-step d-inline-block color-white"><i class="fa fa-instagram"></i></span>
                    <h5 class="font-weight-500 color-white mt-25px mb-15px text-capitalize">Instagram Advertising</h5>
                    <p class="font-weight-light color-white">Grow Money also provides instagram marketing for your business. For this you only need to check our advertising plan and packages  and provide your business information to us.   </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-title wow fadeIn" data-wow-delay="300ms">
                    ...
                    <h2 class="mb-0">Our <span class="color-pink">Grow Money</span> Team </h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-xl-3 p-0 team-col ml-md-auto mr-md-0 mx-auto">
                ...
                <div class="team-classic-content hvr-team pink">
                    ...
                    <ul class="team-social">
                        <li class="d-inline-block"><a href="javascript:void(0)" class="facebook-bg-hvr"><i class="fa fa-facebook-f" aria-hidden="true"></i></a></li>
                        <li class="d-inline-block"><a href="javascript:void(0)" class="twitter-bg-hvr"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                        <li class="d-inline-block"><a href="javascript:void(0)" class="google-bg-hvr"><i class="fa fa-google" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row align-items-center position-relative">
                <div class="col-md-12">
                    <div class="quote-text text-center wow fadeInRight" data-wow-delay="300ms">
                        ...
                        <h2 class="font-weight-light mb-5 line-height-normal"><span class="color-yellow">Let’s start </span> your journey with Grow Money and start earning from your free time.</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-title wow fadeIn" data-wow-delay="300ms">
                    ...
                    <h2 class="mb-0">Grow Money<span class="color-pink"> Portfolio</span> </h2>
                </div>
            </div>

            <div class="col-md-4 mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/1.png" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
                            <h3>Crypto</h3>
                            <p>On the Internet, individuals exchange crypto currency without the use of a bank or government as a middleman. The economy is being transformed by cryptocurrencies, which may be the most significant transformation in centuries. It is the most popular option for a variety of business needs, including online investments, transactions, tokenization, and more.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/gaming.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
                            <h3>Skillbase Gaming Platform</h3>
                            <p>On the Internet, individuals exchange crypto currency without the use of a bank or government as a middleman. The economy is being transformed by cryptocurrencies, which may be the most significant transformation in centuries. It is the most popular option for a variety of business needs, including online investments, transactions, tokenization, and more.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/shoping.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
            ...
            <div class="col-md-4 mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/OTT-platforms.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
                            <h3>OTT Plateform</h3>
                            <p>On the Internet, individuals exchange crypto currency without the use of a bank or government as a middleman. The economy is being transformed by cryptocurrencies, which may be the most significant transformation in centuries. It is the most popular option for a variety of business needs, including online investments, transactions, tokenization, and more.</p>
            ...
            <div class="col-md-4  mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/video-img.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
                            <h3>Short Video App</h3>
                            <p>On the Internet, individuals exchange crypto currency without the use of a bank or government as a middleman. The economy is being transformed by cryptocurrencies, which may be the most significant transformation in centuries. It is the most popular option for a variety of business needs, including online investments, transactions, tokenization, and more.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 mt-3">
                <div class="card card-body">
                    <div class="coming-project-box">
                        <div class="coming-project-img">
                            <img src="img/online-img.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="coming-project-detail">
...
<!-- Work Starts -->
<section id="work" class="pb-0" style="display:none;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="main-title wow fadeIn" data-wow-delay="300ms">
        ...
        <div class="row d-block">
            ...
            <div id="js-filters-mosaic-flat" class="cbp-l-filters-alignCenter">
                ...
                <div data-filter=".graphic-designs" class="cbp-filter-item cbp-filter-style">
                    Facebook Advertisement <div class="cbp-filter-counter"></div>
                </div>
                <div data-filter=".web-designs" class="cbp-filter-item cbp-filter-style">
                    Website Advertisement <div class="cbp-filter-counter"></div>
                </div>
                <div data-filter=".seo" class="cbp-filter-item cbp-filter-style">
                    Youtube Advertisement<div class="cbp-filter-counter"></div>
                </div>
                <div data-filter=".marketing" class="cbp-filter-item">
                   Instagram Advertisement<div class="cbp-filter-counter"></div>
                </div>
            </div>

            <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat no-transition">
                <div class="cbp-item web-designs marketing">
                    <a href="img/1.png" class="cbp-caption cbp-lightbox" data-title="Bolt UI<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/1.png" alt="work">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>On the Internet, individuals exchange crypto currency without the use of a bank or government as a middleman. The economy is being transformed by cryptocurrencies, which may be the most significant transformation in centuries. It is the most popular option for a variety of business needs, including online investments, transactions, tokenization, and more. </p>
                                    <div class="cbp-l-caption-title">Crypto Currency</div>
                ...
                <div class="cbp-item graphic-designs seo">
                    <a href="img/NFT.jpg" class="cbp-caption cbp-lightbox" data-title="World Clock<br>by Paul Flavius Nechita">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/NFT.jpg" alt="work">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>"Non-fungible token" is the meaning of the term NFT. Unique digital asset numbers known as NFTs can convey ownership of digital content such as music, videos, and images. As a leading NFT development company, Webcyst Company serves as a one-stop solution for all of your NFT requirements.</p>
                                    <div class="cbp-l-caption-title">NFT</div>
                                    <!-- <span class="work-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </span> -->
                                </div>
             ...
             <div class="cbp-item graphic-designs web-designs">
                    <a href="https://megaone.acrothemes.com/creative-studio/img/work3.jpg" class="cbp-caption cbp-lightbox" data-title="WhereTO App<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/OTT-platforms.jpg" alt="work">
                        </div>
                         <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>An over-the-top (OTT) media service is a media service offered directly to viewers via the Internet. OTT bypasses cable, broadcast, and satellite television platforms: the types of companies that traditionally act as controllers or distributors of such content</p>
                                    <div class="cbp-l-caption-title">OTT Platform</div>
                                    <span class="work-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </span>
                                </div>
                ...
                <div class="cbp-item seo marketing">
                    <a href="img/e-commerce-platforms.jpg" class="cbp-caption cbp-lightbox" data-title="Remind~Me Widget<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/e-commerce-platforms.jpg" alt="work">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>Ecommerce or electronic commerce is the trading of goods and services on the internet. It is your bustling city center or brick-and-mortar shop translated into zeroes and ones on the internet superhighway.</p>
                                    <div class="cbp-l-caption-title">E-Commerce</div>
                                    <!-- <span class="work-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </span> -->
                                </div>
                ...
                <div class="cbp-item web-designs seo">
                    <a href="img/growPay.jpg" class="cbp-caption cbp-lightbox" data-title="Seemple* Music<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/growPay.jpg" alt="work">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>The largest issuer-independent digital financial services platform in India is Growpay. With services like Mobile Recharges, DTH Recharges, Bill Payments, Money Transfer, Refer & Earn Facility, Repurchase Income, and Cash back for Growpay, Growpay makes it easy to recharge, pay bills, and transfer money.</p>
                                    <div class="cbp-l-caption-title">Growpay Application</div>
                                    <!-- <span class="work-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </span> -->
                                </div>
                ...
                <div class="cbp-item web-designs marketing">
                    <a href="img/gaming.jpg" class="cbp-caption cbp-lightbox" data-title="iDevices<br>by Tiberiu Neamu">
                        <div class="cbp-caption-defaultWrap">
                            <img src="img/gaming.jpg" alt="work">
                        </div>
                        <div class="cbp-caption-activeWrap">
                            <div class="cbp-l-caption-alignCenter">
                                <div class="cbp-l-caption-body">
                                    <p>An online game is a video game that is either partially or primarily played through the Internet or any other computer network available.</p>
                                    <div class="cbp-l-caption-title">Gaming Project</div>
                                    <!-- <span class="work-icon">
                                            <i class="fa fa-arrow-right"></i>
                                        </span> -->
                                </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-images">
                <div class="owl-thumbs owl-dots d-lg-block d-none">
                    <div class="owl-dot animated-wrap active"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial1.png" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial2.png" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial3.png" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial4.png" alt="" class="animated-element"></div>

                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial5.png" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial6.png" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial7.jpg" alt="" class="animated-element"></div>
                    <div class="owl-dot animated-wrap"><img src="https://megaone.acrothemes.com/creative-studio/img/testimonial8.jpg" alt="" class="animated-element"></div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme testimonial-two hide-cursor mx-auto wow zoomIn" data-wow-delay="400ms">
                        <div class="testimonial-item">
                            ...
                            <p class="color-black testimonial-para mb-15px">Grow Money is a unique platform. This is a great income source for their users. </p>
                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial1.png" alt="image"></a>
                        ...
                        <div class="testimonial-item hide-cursor">
                             <i class="fa fa-quote-left fa-2x" aria-hidden="true"></i>
                            <p class="color-black testimonial-para mb-15px">Grow Money provides best advertising plans to advertise business.
 </p>

                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial2.png" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                             <i class="fa fa-quote-left fa-2x" aria-hidden="true"></i>
                            <p class="color-black testimonial-para mb-15px"> It provides multiple types of income to their users and also for free time.
 </p>

                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial3.png" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                             <i class="fa fa-quote-left fa-2x" aria-hidden="true"></i>
                            <p class="color-black testimonial-para mb-15px">Grow Money is a unique platform. Grow Money provides best advertising plans to advertise business. </p>

                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial4.png" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial5.png" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial6.png" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial7.jpg" alt="image"></a>
                                <div class="text-content">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-post">
                                <a href="javascript:void(0)" class="post"><img src="img/testimonial8.jpg" alt="image"></a>
                                <div class="text-content">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 p-0">
                <div class="hover-effect">
                    <img alt="blog" src="img/blog.jpg" class="about-img">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-12 p-lg-0">
                <div class="split-container-setting style-three text-center">
                    <div class="main-title mb-5 wow fadeIn" data-wow-delay="300ms">
                        <!-- <h5 class="font-18 text-blue"> Oct 12, 2022</h5> -->
                        <h2 class="mb-0 font-weight-normal"> Company Blog </h2>
                    </div>
                    <p class="color-black mb-5">Only Grow Money is such a plan where you can earn daily by applying once, without even referring to anyone! You will continue to see your self income from ADS! Everyday If you can make a team, then you can earn 10-15 thousand daily by forming a team, it is up to your team.
</p>

                    <a href="#" class="btn-setting color-black btn-hvr-up btn-blue btn-hvr-pink">learn more</a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                <div class="contact-box">
                    ...
                    <div class="text-center text-md-left">
                        ...
                        <!--Email-->
                        <p class="mb-3"> Email: <a href="mailto:growmoney.me@gmail.com" class="color-black">growmoney.me@gmail.com</a> <br>
                            </p>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <ul class="footer-icons mb-4">
                  <li><a href="https://telegram.me/growmoneyofficiall" target="_blank" class="wow fadeInDown pinterest"><i class="fa fa-telegram"></i> </a> </li>
                   <li><a href="https://www.instagram.com/invites/contact/?i=1gqo49ca04o17&utm_content=q6egiyk" class="wow fadeInUp instagram"><i class="fa fa-instagram"></i> </a> </li>
                    <li><a href="https://www.facebook.com/profile.php?id=100088499649611&mibextid=ZbWKwL" class="wow fadeInUp facebook"><i class="fa fa-facebook-f"></i> </a> </li>
                    <li><a href="javascript:void(0)" class="wow fadeInDown twitter"><i class="fa fa-twitter"></i> </a> </li>
                    <li><a href="javascript:void(0)" class="wow fadeInUp google"><i class="fa fa-google"></i> </a> </li>
                    <li><a href="javascript:void(0)" class="wow fadeInDown linkedin"><i class="fa fa-linkedin-in"></i> </a> </li>
