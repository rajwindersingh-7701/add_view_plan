...
<div class="main-container  mt-152">
    ...
    <div class="page-header">
        ...
        <div class="pull-right" style="margin-right: 10px">
            ...
            <a href="export_withdraw_done.php" target='__blank'><input type='button' class='btn btn-success' value="Export All In XL"></a>
            ...
            <div class="widget">
                ...
                <div class="widget-header">
                    ...
                    <div class="title">
                         ...
                         Withdrawal Pending Amount (Total:-<?php echo $totalSum; ?>)
                ...
                <div class="widget-body">
                    ...
                    <div>
                        ...
                        <form action="" method="get" class="form1" <?php if (isset($_GET['from'])) { ?> style="display:none;" <?php } ?>>
                            ...
                            <a href="withdraw_working_done.php"><input class="orangebuttion" type="button" name="reset" value="Reset"> </a>
                        ...
                        <form action="" method="get" class="form2" <?php if (empty($_GET['from'])) { ?> style="display:none;" <?php } ?>>
                            ...
                            <a href="withdraw_working_done.php"><input type="button" name="reset" value="Reset"> </a>
                            <!-- <a href="wallet_transaction.php"><input type="button" name="" value="Reset"> </a> -->
                    ...
                    <div>
                        ...
                        if ($totalResult > 100) {
                            ...
                            echo "<li><a href='withdraw_working_done.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

                            for ($i = $page; $i <= ($page + 2); $i++) {
                                echo "<li><a href='withdraw_working_done.php?page=" . $i . "'>" . $i . "</a></li>";
                            };
                            echo "<li><a href='withdraw_working_done.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
                            echo "</ul>";
                        ?>
                            <span>
                                <form action=''>
                    ...
                    <?php
                    $quwith = "SELECT sum(amount) as sumwith FROM  `withdraw` where `status`='done' and `type`='INR' ";
                    // if ($_GET['select_type'] != "") {
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $totalwithdrawResult['total_withdraw'];//$dataQuery['withdrawWallet']; ?> Times</td>
                                            ...
                                            <td> <?php echo $dataQuery['remarks']; ?></td>
                                        </tr>
                                    <?php
                                        $i++;
                                    }
