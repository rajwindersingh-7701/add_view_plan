...
if(isset($_GET['select_type'])){
    if($_GET['select_type']!=""){
       ...
       $value = $_GET['v'];
    $q = "SELECT * FROM  `rewards_acheiver` where confirm='1'";
  
    }
   
    if(isset($_GET['from'])){
         $q = "SELECT * FROM  `rewards_acheiver` where confirm='1' and  date >= '".$_GET['from']." 00:00:00'";
    }
    if(isset($_GET['to'])){
 ...
 $totalResult = mysqli_num_rows(mysqli_query($db,"SELECT * FROM  `rewards_acheiver` where confirm='1'")); 
}
?>
