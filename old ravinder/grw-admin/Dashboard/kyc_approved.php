...
<a href="export_kyc_approved.php" target='__blank'><input type='button' class='btn btn-success' value="Export All In XL"></a>
                ...
                <div class="widget-body">
                    <div>
                        ...
                        <form action="" method="get" class="form1" <?php if (isset($_GET['from'])) { ?> style="display:none;" <?php } ?>>
                            ...
                            <a href="kyc_approved.php"><input class="orangebuttion" type="button" name="reset" value="Reset"> </a>
                        ...
                        <form action="" method="get" class="form2" <?php if (empty($_GET['from'])) { ?> style="display:none;" <?php } ?>>
                            ...
                            <a href="kyc_approved.php"><input type="button" name="reset" value="Reset"> </a>
                    ...
                    <div>
                        ...
                        if ($totalResult > 100) {
                            ...
                            echo "<li><a href='kyc_approved.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

                            for ($i = $page; $i <= ($page + 2); $i++) {
                                echo "<li><a href='kyc_approved.php?page=" . $i . "'>" . $i . "</a></li>";
                            };
                            echo "<li><a href='kyc_approved.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
                            echo "</ul>";
                        ?>
                        <?php } ?>
                    </div>
