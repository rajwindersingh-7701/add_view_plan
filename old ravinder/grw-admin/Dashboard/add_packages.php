...
if (isset($_GET['delete'])) {
    mysqli_query($db, "DELETE FROM `package` WHERE id='" . $_GET['delete'] . "'");
    $_SESSION["package"] = array("msg" => "Package record Succefully deleted!", "status" => false);
            ...
            <div class="widget-body">
                <div class="form-horizontal no-margin">
                    <form action="controller/function.php" method="post">
                        ...
                        <?php
                        $query = mysqli_query($db, "SELECT * FROM  `pacakge`  order by id asc ");
                        ...
                        if (isset($_GET['pack'])) {
                            ...
                            $levelcurrent = $levelDataq['package'];
                        }
                        ?> 
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="form-control" readonly="true" name="package" type="text" value='<?php echo $levelcurrent; ?>' required>
                            ...
                            <div class="col-md-2">
                                <div class="control-group">
                                    <label class="control-label">Level Condition(required)</label>
                                    <div class="controls">
