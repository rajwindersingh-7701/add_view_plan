...
if (isset($_GET['select_type'])) {
    ...
    $totalResult1 = mysqli_fetch_array(mysqli_query($db, "SELECT count(*) as count FROM `user_kyc` where kyc_status = '0' "));
...
<a href="export_kyc_request.php" target='__blank'><input type='button' class='btn btn-success' value="Export All In XL"></a>
        ...
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        List of KYC Pending (Total:-<?php echo $totalResult; ?>)
                    </div>
                </div>
                ...
                <div class="widget-body">
                    ...
                    <div>
                        ...
                        if ($totalResult > 100) {
                            ...
                            echo "<li><a href='kyc_request.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

                            for ($i = $page; $i <= ($page + 2); $i++) {
                                echo "<li><a href='kyc_request.php?page=" . $i . "'>" . $i . "</a></li>";
                            };
                            echo "<li><a href='kyc_request.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
                            echo "</ul>";
                        ?>
                        <?php } ?>
                    </div>
                        ...
                        <form action="controller/function.php" method='post'>
                            ...
                            <table id="myTable" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    $q = "SELECT * FROM  `user_kyc` where kyc_status = '0'";
                                    if (isset($_GET['select_type'])) {
                                        $column = $_GET['select_type'];
                                        $value = $_GET['v'];
                                        if ($_GET['select_type'] != "") {
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <!--                                            <td>    
                                                 <?php if (isset($dataQuery['pan_img'])) {
                                                        if (substr($dataQuery['pan_img'], -3) == "pdf") { ?>
                                                  <a href="<?php echo "../../Dashboard/" . $dataQuery['pan_img']; ?>" download><i class="ti-download pr-2"></i>Download PDF</a>
                                                 <?php  } else { ?>
                                                <a href="<?php echo "../../Dashboard/" . $dataQuery['pan_img']; ?>" target="_blank" >
                                                <img src="<?php echo "../../Dashboard/" . $dataQuery['pan_img']; ?>" width="100"> 
                                                </a>
                                                 <?php }
                                                    } ?>
                                            </td>
                                            <td>
                                                <?php if (isset($dataQuery['bank_img'])) { ?>
                                                <a href="<?php echo "../../Dashboard/" . $dataQuery['bank_img']; ?>" target="_blank" >
                                                <img src="<?php echo "../../Dashboard/" . $dataQuery['bank_img']; ?>" width="100"> 
                                                </a>
                                             <?php } ?>
                                            </td>
                                            <td>
                                                 <?php if (isset($dataQuery['adhar_img'])) { ?>
                                                <a href="<?php echo "../../Dashboard/" . $dataQuery['adhar_img']; ?>" target="_blank" >
                                                <img src="<?php echo "../../Dashboard/" . $dataQuery['adhar_img']; ?>" width="100"> 
                                                </a>
                                                <?php } ?>
                                            </td>-->
