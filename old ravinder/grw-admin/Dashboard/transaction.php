...
<div class="main-container mt-152">
    ...
    <div>
        <?php $amt = "SELECT SUM(amount) FROM `wallet` WHERE 'type' = 'credit'";
        ...
        if ($totalResult > 100) {
            ...
            echo "<li><a href='transaction.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

            for ($i = $page; $i <= ($page + 2); $i++) {
                echo "<li><a href='transaction.php?page=" . $i . "'>" . $i . "</a></li>";
            };
            echo "<li><a href='transaction.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
            echo "</ul>";
        ?>
        <?php } ?>
    </div>
