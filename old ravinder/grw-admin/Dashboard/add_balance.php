                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name='walletType'>
                                                <option value="INR">Main Wallet</option>
                                                <option value="epin"> E-wallet</option>
                                                <!--<option value="ROI">Non Working</option>-->
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <!--<input class="span12 password" name="des" type="text" required>-->
                                        </div>
                                    </div>
                                    <div class="form-actions no-margin">
                                        <button  type="submit" name="transfer-balance" class="btn btn-primary loginpassword">Transfer</button>
