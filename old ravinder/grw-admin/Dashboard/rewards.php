...
if (isset($_GET['select_type'])) {
    ...
    if ($_GET['select_type'] != "") {
        ...
        $q = "SELECT * FROM  `rewards` where $column='$value'";
    ...
    if (isset($_GET['from'])) {
        ...
        if ($_GET['from'] != "") {
            ...
            $q = "SELECT * FROM  `rewards` where datetime >= '" . $_GET['from'] . " 00:00:00'";
            ...
            <div class="widget">
                ...
                <div class="widget-header">
                    ...
                    <div class="title">
                        ...
                        List of Rewards (Total:-<?php echo $totalResult; ?>)
...
//$userId = $user["id"];
                                ...
                                <td><?php echo $dataQuery['bouns']; ?></td>
                                <td><?php echo $dataQuery['reward']; ?></td>
                                <td><a href="rewards_edit.php?uid=<?php echo $dataQuery['id']; ?>">Edit</a></td>
                            </tr>
    ...
    <script src="../../DashboardOLD/assets/js/bootstrap.js"></script>
