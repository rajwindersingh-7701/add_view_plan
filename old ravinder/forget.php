            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="model/ajax.php" method="post" class="sl-form">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Forget your password</h5>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="hidden" name="forget" value="login" />
                  </div>
                  ...
                  <a class="text-dark h6" href="login.php">Login ?</a>
