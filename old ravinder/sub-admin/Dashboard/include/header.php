...
if (empty($_SESSION["subadmin"])) {
    echo "<script type='text/javascript'> document.location = '../'; </script>";
    exit;
}
$adminid = $_SESSION["subadmin"]['id'];
$adminquery = mysqli_query($db, "SELECT * FROM `sub_admin` WHERE id='$adminid'");
$adminData = mysqli_fetch_array($adminquery);
if ($adminData['password'] != $_SESSION["subadmin"]['password']) {
