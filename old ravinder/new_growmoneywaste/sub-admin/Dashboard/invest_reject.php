...
if (isset($_GET['select_type'])) {
    ...
    if (isset($_GET['from'])) {
        if ($_GET['from'] != "") {
            $q = "SELECT * FROM  `payment_invest` where status='reject' and date >= '" . $_GET['from'] . " 00:00:00'";
            $totalResult = mysqli_num_rows(mysqli_query($db, $q));
        }
    }
    if (isset($_GET['to'])) {
    ...
    $totalResult = mysqli_num_rows(mysqli_query($db, "SELECT id FROM `payment_invest` where status='reject'"));
    $totalSum = mysqli_fetch_array(mysqli_query($db, "SELECT SUM(amount) as sm FROM `payment_invest` WHERE status = 'reject'"));
}
?>
            ...
            <div class="widget">
                ...
                <div class="widget-header">
                    ...
                    <div class="title">
                        ...
                        List of all Fund (Total:-<?php echo $totalResult; ?>)

                    </div>
                    <div class="title">

                        Rejected Fund (Total:-<?php echo $totalSum['sm']; ?>)
                ...
                <div class="widget-body">
                    ...
                    <div>
                        ...
                        if ($totalResult > 100) {
                            ...
                            echo "<li><a href='invest_reject.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

                            for ($i = $page; $i <= ($page + 2); $i++) {
                                echo "<li><a href='invest_reject.php?page=" . $i . "'>" . $i . "</a></li>";
                            };
                            echo "<li><a href='invest_reject.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
                            echo "</ul>";
                        ?>
                            <span>
                                <form action=''>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="myTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $q = "SELECT * FROM  `payment_invest` where status='reject'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <?php if ($dataQuery['status'] == 'reject') { ?> <p style="color: red;"> <?php echo $dataQuery['status']; ?></p> <?php } else { ?> <p style="color: green;"> <?php echo $dataQuery['status']; ?></p> <?php } ?> </td>
