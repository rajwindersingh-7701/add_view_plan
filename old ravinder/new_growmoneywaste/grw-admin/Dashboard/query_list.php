                                ...
                                while ($dataQuery = mysqli_fetch_array($queryUser)) {
                                    ...
                                    <td><?php echo $dataQuery['datetime']; ?>   </td>
                                        <td>
                                               ...
                                               <a  onclick="return confirm('Are you sure!')" href="controller/function.php?query_uid=<?php echo $dataQuery['id']; ?>" class="btn btn-warning " data-original-title="">done</a>  
                                        </td>
                                         <td> 
                                            <a href="query_list_chat.php?uid=<?php echo  $dataQuery['user_id']; ?>" class="btn btn-warning ">Chat</a>
                                        </td>
