...
//        }
    ...
    $totalResult1 = mysqli_fetch_array(mysqli_query($db, "SELECT count(*) as count FROM `withdraw` where status!='done' and type='epin'"));
...
<div class="main-container  mt-152">
    ...
    <div class="page-header">
        ...
        <div class="pull-left">
            ...
            <h2 style='color:darkred;'>E-wallet Withdrawal Pending Requests</h2>
...
//Pagination 
                    ...
                    <?php
                    $quwith = "SELECT sum(amount) as sumwith FROM  `withdraw` where `status`='pending' and `type`='epin' ";
                    if ($_GET['select_type'] != "") {
                    ...
                    echo '<h1>Total Pending Amount :- ' . round($dollarWith) . '</h1>';
                    ?>  
...
//Search data query
                                    ...
                                    $q = "SELECT * FROM  `withdraw` where status!='done' and `type`='epin' ";
                                    if (isset($_GET['select_type'])) {
                                        ...
                                        <!--<input type="hidden" name="userId" id='uid' value="">-->
                                            ...
                                            <div style="width:60%;margin: 0 auto;"> 
                                                ...
                                                <!--<input type="text" onChange="checkUser()" id="user" onFocus="checkUser()" class="form-control" name="userId" placeholder="Enter User Id">-->
                                                    ...
                                                    <input type="hidden" name='wallettype' value='roi'>
