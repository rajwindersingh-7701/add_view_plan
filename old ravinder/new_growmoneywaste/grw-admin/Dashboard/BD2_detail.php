        ...
        <div class="span12">
            <div class="widget">
                <div class="widget-header">
                    <div class="title">
                        List of epin Transaction (Total:-<?php echo $totalResult; ?>)
                    </div>
                    <div class="title">
                        Amount of epin Transaction (Total:-<?php echo $totalSum['sm']; ?>)
                    </div>
                </div>
                <div class="widget-body">
                    <div>
                        ...
                        <form action="" method="get" class="form2" <?php if (empty($_GET['from'])) { ?> style="display:none;" <?php } ?>>
                            ...
                            <a href="tds_detail.php"><input type="button" name="reset" value="Reset"> </a>
                        </form>
                    </div>
                    <div>
                        <?php
                        ...
                        if ($totalResult > 100) {
                            ...
                            echo "<li><a href='BD2_detail.php?page=" . ($page - 1) . "' class='button'>Previous</a></li>";

                            for ($i = $page; $i <= ($page + 2); $i++) {
                                echo "<li><a href='BD2_detail.php?page=" . $i . "'>" . $i . "</a></li>";
                            };
                            echo "<li><a href='BD2_detail.php?page=" . ($page + 1) . "' class='button'>NEXT</a></li>";
                            echo "</ul>";
                        ?>
                        <?php } ?>
                    </div>
