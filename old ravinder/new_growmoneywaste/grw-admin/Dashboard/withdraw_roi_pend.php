...
//Pagination 
                    ...
                    <?php
                    $quwith = "SELECT sum(amount) as sumwith FROM  `withdraw` where `status`='pending' and `type`='ROI' ";
                    if ($_GET['select_type'] != "") {
                                    ...
                                    while ($dataQuery = mysqli_fetch_array($queryUser)) {
                                        ...
                                        <tr>                                   
                                            ...
                                            <?php if ($dataQuery['ban'] == '') { ?>
                                                <td>
                                                    Bank Name:-<?php echo $userresult['bank_name']; ?><br>
                                                    IFSC  :-<?php echo $userresult['bank_ifsc']; ?><br>
                                                    Ac. Name:-<?php echo $userresult['account_name']; ?><br>
                                                    Ac No.:-<?php echo $userresult['account_number']; ?><br>
                                                </td>
                                            <?php } else { ?>
                                                <td>
                                            ...
                                            <td><div id="btnarea"><a class="btn btn-Danger" href='controller/function.php?deleteroiwithdraw1=<?php echo $dataQuery['id']; ?>' onclick="confirm('Delete withdraw <?php echo $userresult['name']; ?>')">Delete</a></div></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
