    ...
    <div id="edit-personal-details" style="display: block" class="accord bg-offwhite shadow">
        <div class="content-edit-area">
            <div class="edit-header">
                <h4>Transfer Pay wallet to E-wallet</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 profile-area">
                    <div class="edit-content">
                        ...
                        $activeright = mysqli_num_rows(mysqli_query($db, "select `id` from `user` where `sponser`='" . $userData['user_id'] . "'"));
                        $checkUser = 'SELECT * FROM `user` WHERE `sponser_by` = ' . $user_id . '';
                        // if (count($activeright) >= 2) {
                        // if ($checkUser >= 2) {
                            ...
                            <form action="controller/paymentContrroller.php" method="post">
                                ...
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <h4>E-wallet balance <?php echo $walletbtc; ?></h4>
                                            <h4>User can transfer minimum 10.</h4>
                                    ...
                                    <div class="form-actions " style="margin-top:20px;">
                                        <button type="submit" name="pay-transfer-money" class="btn btn-default loginpassword col-5">Transfer</button>
