                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="demo@my.com" class="form-control" data-pr-form="emailid" id="emailID" required placeholder="Email ID">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="+2 321-5234-0112" class="form-control" data-pr-form="mobile-number" id="mobile-number" required placeholder="Mobile Number">
                                                        </div>
                                                        <div class="form-group">
                            ...
                            <div class="tab-content">
                                <div id="menu1" class="tab-pane fade in active">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="col-sm-9">+2 321-2345-0112</p>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <p class="col-sm-3"><b>Address</b></p>
                                        <p class="col-sm-9">1601 Austin Farms Rd, Ortonville, MI, 48462, Suite 100-18, San Ditego, California - 2434, United States.</p>
                                    </div>
                                    <hr>
                                    <div class="row">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered " role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="http://demo.themeies.com/probill/post">
                                ...
                                <div id="menu2" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="col-sm-9">Business <a href="#" class="close-account" data-toggle="modal" data-target="#closeaccount"><i class="fas fa-times"></i> Close Account</a></p>
                                    </div>
    ...
    <footer class="footer">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget-navigation">
                            <h4 class="widget-title">About Yacht</h4>
        ...
        <div class="foo-btm">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright text-left el-sm-center">Copyright © <script>
                    ...
                    <div class="col-md-6">
                        <ul class="payments-types text-right  el-sm-center">
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="images/pay/visa.png" alt="visa" title="" data-original-title="Visa"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="images/pay/discover.png" alt="discover" title="" data-original-title="Discover"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="images/pay/paypal.png" alt="paypal" title="" data-original-title="PayPal"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="images/pay/american.png" alt="american express" title="" data-original-title="American Express"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="images/pay/mastercard.png" alt="Mastercard" title="" data-original-title="Mastercard"></a></li>
                        </ul>
                    </div>
                </div>
...
<!-- Mirrored from demo.themeies.com/probill/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Apr 2020 06:39:18 GMT -->
</html>