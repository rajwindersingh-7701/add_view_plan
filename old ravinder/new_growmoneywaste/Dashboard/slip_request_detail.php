...
if (isset($_GET['select_type'])) {
    if ($_GET['select_type'] != "") {
        ...
        $value = $_GET['v'];
        $q = "SELECT * FROM  `payment_invest` where `user_id`= '$user_id' &&  $column='$value'";
    }
    if (isset($_GET['from'])) {
        $from = date("Y-m-d", strtotime($_GET['from']));
        $q = "SELECT * FROM  `payment_invest` where `user_id`= '$user_id' && datetime >= '$from 00:00:00'";
    }
    if (isset($_GET['to'])) {
    ...
    $totalResult = mysqli_num_rows(mysqli_query($db, "SELECT id FROM  `payment_invest` where `user_id`= '$user_id'"));
}
?>
<style>
...
<div class="col-lg-9">
    ...
    <div class="profile-content">
        ...
        <div class="transaction-title bg-offwhite">
            <div class="items">
                <div class="row">
                    ...
                    <div class="col col25p">Satus</div>
        ...
        <div class="transaction-area">
            ...
            $q = "SELECT * FROM `payment_invest` where `user_id`= '$user_id' ";
            if (isset($_GET['select_type'])) {
                $column = $_GET['select_type'];
                $value = $_GET['v'];
                if ($_GET['select_type'] != "") {
                ...
                <div class="items">
                    <a href="#">
                        <div class="row">
                            ...
                            <div class="col col25p">
                                <span class="name"><?php echo $dataQuery1['status']; ?></span>
                            </div>
                            <div class="col col25p" >
