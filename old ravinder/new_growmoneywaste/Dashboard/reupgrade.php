    ...
    <div id="edit-personal-details" style="display: block" class="accord bg-offwhite shadow">
        <div class="content-edit-area">
            <div class="edit-header">
                <h5 class="title">Re-upgrade your account</h5>
                ...
                <div class="col-lg-6 profile-area">
                    <div class="edit-content">
                        <form id="personaldetails" action="controller/paymentContrroller.php" method="post">
                            <?php if (isset($_SESSION["upgrade"])) if ($_SESSION["upgrade"]["status"] == false) echo "<p style='color:red' class='false' >" . $_SESSION['upgrade']['msg'] . "</p>"; ?> <?php if (isset($_SESSION["upgrade"])) if ($_SESSION["upgrade"]["status"] == true) echo "<p id='response-msg' class='true' >" . $_SESSION['upgrade']['msg'] . "</p>";unset($_SESSION["upgrade"]); ?> 
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="btn-link float-left mb-3"><button class=" btn btn-default" type="submit" name='repay-with-wallet-other'><i class="far fa-save"></i> BUY NOW</button></div>
