...
<!-- Container Panel  -->
<div class="col-lg-9">
    <h2 class="admin-heading bg-offwhite">Withdraw Detail</h2>
    <!-- Filter -->
    <!-- Filter End -->
    <!-- All Transactions  -->
    <div class="profile-content">
        ...
        <div class="transaction-title bg-offwhite">
            <div class="items">
                <div class="row">
                    <div class="col col15p" ><span class="">Admin Charge</span></div>
                    <div class="col col15p" ><span class="">Withdraw</span></div>
                    <div class="col col15p">Total Request</div>
                    <div class="col col15p">Status</div>
        ...
        <div class="transaction-area">
            ...
            $q = "SELECT * FROM `withdraw` where `userId`= '$userId' ";
            if (isset($_GET['select_type'])) {
                $column = $_GET['select_type'];
                $value = $_GET['v'];
                if ($_GET['select_type'] != "") {
                    ...
                    <a href="#">
                        <div class="row">
                            <div class="col col15p" >
                                <span class="name"><?php echo $dataQuery1['admin']; ?></span>
                            </div>
                            <div class="col col15p">
                                <span class="name"><?php echo $dataQuery1['amount']; ?></span>
                            </div>
                            <div class="col col15p">
                                <span class="name"><?php echo $dataQuery1['amount']+$dataQuery1['admin']; ?></span>
                            </div>
                            <div class="col col15p" >
                                <span class="payment-amaount"> <?php echo $dataQuery1['status']; ?></span>
                            </div>
                            <div class="col " >
                                <span class="payment-amaount"><b>Request:-</b> <br><?php echo $dataQuery1['date']; ?><br><b>Confirm:-</b><br> <?php echo $dataQuery1['confirmDate']; ?></span>
                            </div>
                             <div class="col" >
                                <span class="payment-amaount"><b>Desc:-</b> <?php echo $dataQuery1['description']; ?></span>
                            </div>
                        </div>
                    </a>
                </div>
