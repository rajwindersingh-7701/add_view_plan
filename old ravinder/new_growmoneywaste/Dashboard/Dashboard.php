...
.box-header.with-border>h3 {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Submit Your all detail and than your withdraw is activated
      </h1>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
		...
		<div class="box box-info">
			<div class="box-header with-border"><h3 class="box-title">Edit Account</h3></div>
		</div>
                                               ...
                                               <?php  $kyc == 0;
                                                ...
                                                <div class="control-group col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <?php // } ?>
                                                        <img src="uploads/kyc/<?php echo $kycDatan['image_name'];?>" onerror="this.src='dist/img/gal.jpg';" alt="005" title="005" style="
    width: 100px;
">  
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <img src="uploads/kyc/<?php echo $kycDatap1['image_name'];?>" onerror="this.src='dist/img/gal.jpg';" alt="005" title="005" style="
    width: 100px;
">  
                                                    </div>
                                                </div>
                                                <div class="control-group col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <input class="form-control" name="photo_id"  type="file" value="">
                                                          <?php // } ?>
                                                        <img src="uploads/kyc/<?php echo $kycDatap['image_name'];?>" onerror="this.src='dist/img/gal.jpg';" alt="005" title="005" style="
    width: 100px;
">  
                                                    </div>
                                                </div>
                                                <div class="control-group col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <img src="uploads/kyc/<?php echo $kycDatapp['image_name'];?>" onerror="this.src='dist/img/gal.jpg';" alt="005" title="005" style="
    width: 100px;
">  
                                                    </div>
                                                </div>
                                                <div class="control-group col-lg-6">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <img src="uploads/kyc/<?php echo $kycDatappPhoto['image_name'];?>" onerror="this.src='dist/img/gal.jpg';" alt="005" title="005" style="
    width: 100px;
">  
                                                    </div>
                                                </div>
