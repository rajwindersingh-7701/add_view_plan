                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url('Admin/Management/user_login/' . $user['user_id']); ?>" target="_blank"></a>
                            <a href="<?php echo base_url('Admin/Settings/EditUser/' . $user['user_id']); ?>" target="_blank"></a>
                            <?php
                            if ($user['disabled'] == 0) {
                              echo '<a class="blockUser" data-status="1" data-user_id="' . $user['user_id'] . '"></a> ';
                            } else {
                              echo '<a class="blockUser" data-status="0" data-user_id="' . $user['user_id'] . '"></a> ';
                            }
