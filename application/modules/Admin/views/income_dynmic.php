        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <a href="<?php echo $base_url . '?export=xls'; ?>" class="export-btn btn-primary"><img src="https://growmoney.me//NewDashboard/assets/images/xls.png">Export to xls</a>
                </div>

                <div class="col-md-3">
                  <a href="<?php echo $base_url . '?export=csv'; ?>" class="export-btn btn-success"><img src="https://growmoney.me//NewDashboard/assets/images/csv.png">Export to cvs</a>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $income['user']['phone']; ?></td>
