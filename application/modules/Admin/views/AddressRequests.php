              ...
              <div class="card-header">
                <div class="card-tools">
                  ...
                  <!-- <div class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <a href="<?php echo base_url('Admin/Withdraw/ApprovedAddressRequests?export=xls'); ?>" class="export-btn btn-primary"><img src="<?php echo base_url('NewDashboard/');?>assets/images/xls.png">Export to xls</a>
