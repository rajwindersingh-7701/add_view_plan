              ...
              <div class="card-body">
                ...
                <?php echo form_open_multipart();?>
                    ...
                    <div class="form-group" id="youtube" style="display:none;">
                        ...
                        <input type="text" name="youtube" value="<?php echo $task['link'] ?>" class="form-control" value="<?php echo set_value('link')?>" placeholder="Enter Youtube Video Id"/>
                        <label class="text-danger"><?php echo form_error('link');?></label>
                    </div> -->
                    <div class="form-group" id="youtube" style="display:block;">
                        <label>Site Link</label>
                        <input type="text" name="youtube" class="form-control" value="<?php $task['link']; ?>" placeholder="Enter Site Link"/>
                        <label class="text-danger"><?php echo form_error('link');?></label>
                    </div>
