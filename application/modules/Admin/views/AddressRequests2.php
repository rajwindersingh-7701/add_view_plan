              ...
              <div class="card-header">
                <div class="card-tools">
                  ...
                  <!-- <div class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <a href="<?php echo base_url('Admin/Withdraw/AddressRequests?export=xls'); ?>" class="export-btn btn-primary"><img src="<?php echo base_url('NewDashboard/');?>assets/images/xls.png">Export to xls</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($user['kyc_status'] == 1){
                                        ...
                                        echo '<button class="btn btn-danger apvbtn2" data-id="'.$user['id'].'" data-status="3">Reject</button>';
                                ...
                                echo '<button class="badage badage-danger ">Rejected</button>  <button class="btn btn-warning apvbtn" data-id="'.$user['id'].'" data-status="1">Make Pending</button>';
...
$(document).on('click','.apvbtn2',function(){
    var id = $(this).data('id');
    var status = $(this).data('status')
    var url = '<?php echo base_url("Admin/Withdraw/ApproveUserAddressRequest/");?>'+id + '/' + status;
    var r = confirm("Are You Sure to Reject this User for Withdraw");
    if (r == true) {
        $.get(url ,function(res){
            alert(res.message)
            if(res.success == 1)
