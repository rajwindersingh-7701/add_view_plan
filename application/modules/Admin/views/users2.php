      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Today Joining</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="card-header">
                  <form method="GET" action="<?php echo base_url('Admin/Management/today_joinings/'); ?>">
                    <div class="row">
                      <div class="col-md-3">
                ...
                <div class="export-table">
                  <!-- <a href="<?php echo base_url('Admin/Management/today_joinings?export=xls'); ?>" class="export-btn btn-primary"><img src="<?php echo base_url('NewDashboard/'); ?>assets/images/xls.png">Export to xls</a>
                  <a href="<?php echo base_url('Admin/Management/today_joinings?export=csv'); ?>" class="export-btn btn-success"><img src="<?php echo base_url('NewDashboard/'); ?>assets/images/csv.png">Export to csv</a>
                  <a href="<?php echo base_url('Admin/Management/today_joinings?export=txt'); ?>" class="export-btn btn-info "><img src="<?php echo base_url('NewDashboard/'); ?>assets/images/txt.png">Export to txt</a> -->
                </div>
                <!-- /.card-header -->
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php if ($user['upgrade_id'] > 0) {
                                echo $user['upgrade_package'];
                              } else {
                                echo 0;
                              } ?></td>
