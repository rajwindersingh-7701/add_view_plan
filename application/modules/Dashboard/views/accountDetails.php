                    ...
                    <div class="tab-content p-0">
                        ...
                        <div class="">
                            ...
                            <div class="col-md-12 card">
                                ...
                                <div class="card-body">
                                    <div class="panel panel-default">
                                        <h3><?php if ($user_bank['kyc_status'] == 0 || $user_bank['kyc_status'] == 1) {
                                                echo "Pending";
                                            } elseif ($user_bank['kyc_status'] == 2) {
                                                echo "Approved";
                                            } elseif ($user_bank['kyc_status'] == 3){
                                                echo "Rejected"; ?>
                                                <!-- <h3 class="text-danger"><?php //echo $user_bank['remark'] ?></h3> -->
                                                <?php
                                            }
                                                ?></h3>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="bank_name" value="<?php echo $bankinfo->bank_name; ?>" placeholder="Enter Bank Name" required>
                                            </div>
                                            </div>
                                            <div class="col-md-6 px-0">
                                            <div class="form-group">
                                                <label for="txtoldpass">Bank Account Holder</label>
                                                <input type="text" class="form-control" name="account_holder_name" value="<?php echo $userinfo->name; ?>" placeholder="" readonly>
                                            </div>
                                        </div>
                                            <div class="col-md-6 px-0">
                                            <div class="form-group">
                                                <label for="txtoldpass">Bank Account Number</label>
                                                <input type="text" class="form-control" name="bank_account_number" value="<?php echo $bankinfo->bank_account_number; ?>" placeholder="Enter Account Number " required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 px-0">
                                            <div class="form-group">
                                                <label for="txtoldpass">IFSC Code</label>
                                                <input type="text" class="form-control" name="ifsc_code" value="<?php echo $bankinfo->ifsc_code; ?>" placeholder="Enter IFSC Code" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 px-0">
                                            <div class="form-group">
                                                <label for="txtoldpass">Aadhar Number</label>
                                                <input type="text" class="form-control" name="aadhar" value="<?php echo $bankinfo->aadhar; ?>" placeholder="Enter Aadhar Number" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 px-0">
                                            <div class="form-group">
                                                <label for="txtoldpass">PAN Number</label>
                                                <input type="text" class="form-control" name="pan" value="<?php echo $bankinfo->pan; ?>" placeholder="Enter PAN Number" required>
                                            </div>
                                        </div>
                                            <div id="SLgPWD"></div>
                                    ...
                                    <div ui-view="" class="fade-in-up ng-scope">
                                        <div class="container-fluid my-documents-page">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="lead">
                                                        Verify your Identity and Proof of Residence in order to activate your account and get access to all areas of <?php echo title; ?>.
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="panel-body pt5 pb5">
                                                            <div class="">
                                                                <div class="">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="verification-img" id="ImgID">
                                                                                        ...
                                                                                        if ($user_bank['id_proof'] != '') {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof']) . '" class="img-responsive"><br>';
                                                                                        } else {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof']) . '" alt="no-image" class="img-responsive" ><br>';
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                     ...
                                                                                     <div class="col-md-4">
                                                                                        ...
                                                                                        if ($user_bank['id_proof2'] != '') {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof2']) . '" class="img-responsive"><br>';
                                                                                        } else {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof2']) . '" alt="no-image" class="img-responsive"><br>';
                                                                                            echo '<span class="wanki">Not Uploaded</span>';
                                                                                        }
                                                                                        ?>
                                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4"><span class="document-verify-step1 lead mb0">
                                                                                        <i class="ti-user color-light-blue" style="color: #007aff;"></i>
                                                                                        Pan Card
                                                                                    </span>
                                                                                </div>
                                                                    <div class="col-md-4">
                                                                          <div class="verification-img" id="ImgID">
                                                                                        ...
                                                                                        if ($user_bank['id_proof3'] != '') {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof3']) . '" class="img-responsive"><br>';
                                                                                        } else {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof3']) . '" alt="no-image" class="img-responsive"><br>';
                                                                                            echo '<span class="wanki">Not Uploaded</span>';
                                                                                        }
                                                                                        ?>
                                                                                    </div>
                                                                     ...
                                                                     <div class="col-md-4">
                                                                          <div class="verification-img" id="ImgID">
                                                                                        ...
                                                                                        if ($user_bank['id_proof4'] != '') {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof4']) . '" class="img-responsive"><br>';
                                                                                        } else {
                                                                                            echo '<img src="' . base_url('uploads/' . $user_bank['id_proof4']) . '" alt="no-image" class="img-responsive"><br>';
                                                                                            echo '<span class="wanki">Not Uploaded</span>';
                                                                                        }
                                                                                        ?>
                                                                                    </div>
...
<script type="text/javascript">
    ...
    // $.get('<?php //echo base_url("Assets/banks.json")
                ?>',function(res){
