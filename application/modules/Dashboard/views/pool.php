                    ...
                    <li>
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Dashboard/User/Pool/'.$direct['user_id'].'/'.$level);?>">
                                            <img src="<?php echo base_url('uploads/active.png');?>">
                                        </a>
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        foreach ($direct['l2'] as $k => $l2) {
                                            ...
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Dashboard/User/Pool/'.$l2['user_id'].'/'.$level);?>">
                                                        <img src="<?php echo base_url('uploads/active.png');?>">
                                                    </a>
                                                    <span><?php echo $l2['user_id']; ?></span><br>
                                                    <!-- <span><?php //echo $l2['username']['name']; ?></span>    -->
                                                </div>
