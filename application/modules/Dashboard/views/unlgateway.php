                                                        ...
                                                        <div class="tab-pane active show" id="tabFundRequestForm">
                                                            <div class="row justify-content-center">
                                                                <div class="w-100 mb-3">
                                                                    ...
                                                                    <p class="h6 mb-2 text-danger">You have 10 minutes to process payment</p>
                                                                    <div class="card shadow-lg">
                                                                        <?php 
                                                                            echo '<h3 class="text-danger">'.$this->session->flashdata('message').'</h3>';
                                                                        ...
                                                                        <div class="">
                                                                            ...
                                                                            <div class="form-group has-feedback">
                                                                                <label for="pwd">Enter UTR Number:</label>
                                                                                <input type="text" class="form-control" name="utr" value="<?php echo set_value('utr');?>">
                                                                                <span class="text-danger"><?php echo form_error('utr');?></span>
                                                                            </div>
                                                                            <div class="form-group has-feedback">
                                                                                <label for="pwd">Receipt:</label>
