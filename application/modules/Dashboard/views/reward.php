...
<div class="card">
    ...
    <h1 style="text-align:center;color:#3fbfd7">ROYALTY</h1>
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <?php
            $awardsArr = [
                '1' => ['rank' => 'DIAMOND', 'ids' => '50', 'bonus_month' => '5,000', 'time_period' => '12 Month','status'=> 1],
                '2' => ['rank' => 'CROWN', 'ids' => '75', 'bonus_month' => '7,500', 'time_period' => '12 Month','status'=> 2],
                '3' => ['rank' => 'KOHINOOR', 'ids' => '100', 'bonus_month' => '10,000', 'time_period' => '12 Month','status'=> 3],
      ...
      <div class="box-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped dataTable" id="">
                    ...
                    <tbody>
                       <?php 
                        $response = $this->User_model->get_single_record('tbl_users', ['user_id' => $this->session->userdata['user_id']], '*');
                       ...
                       ?>
                            ...
                            <td>5,000</td>
                            <td>12 Month</td>
                            <td><?php  if($response['royalty_status']==0) {
                         echo   $art = '<span class="badge badge-danger">Not Achieved</span>';
                        }elseif($response['royalty_status']==1||$response['royalty_status']==2||$response['royalty_status']==3) {
                        echo    $art =  '<span class="badge badge-success"> Achieved</span>';
                        }elseif($response['royalty_status']==2) {
                          echo  $art =  '<span class="badge badge-success"> Achieved</span>';
                        }
                        ...
                        <tr>
                            ...
                            <td>7,500</td>
                            <td>12 Month</td>
                            <td><?php  if($response['royalty_status']==0||$response['royalty_status']==1) {
                         echo   $art = '<span class="badge badge-danger">Not Achieved</span>';
                        }elseif($response['royalty_status']==2||$response['royalty_status']==3) {
                        echo    $art =  '<span class="badge badge-success"> Achieved</span>';
                        }
                        ...
                        <tr>
                            ...
                            <td>10,000</td>
                            <td>12 Month</td>
                            <td><?php  if($response['royalty_status']==0||$response['royalty_status']==1||$response['royalty_status']==2) {
                         echo   $art = '<span class="badge badge-danger">Not Achieved</span>';
                        }elseif($response['royalty_status']==3) {
                        echo    $art = '<span class="badge badge-success"> Achieved</span>';
                        }
