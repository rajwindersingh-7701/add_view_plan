    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <div class="socail-account">
          <ul>
            <li><a href="#" target="_blank"><i class="fb-icon"></i></a></li>
            <li><a href="#" target="_blank"><i class="insta-icon"></i></a></li>
            <li><a href="#" target="_blank"><i class="p-icon"></i></a></li>
            <li><a href="#" target="_blank"><i class="tw-icon"></i></a></li>
            <li><a href="#" target="_blank"><i class="yt-icon"></i></a></li>
            <li><a href="#" target="_blank"><i class="in-icon"></i></a></li>
          </ul>
        </div>
      </div>
      <div class="col-sm-12">
        <div class="copy-right">
          <p>2021 © <?php echo title;?>. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </div>
