                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <a class="footer-brand mr-lg-5 d-flex" href="index.html">
                            <img src="<?php echo base_url(logo);?>" class="mr-3" alt="Footer logo">
                        </a>
                ...
                <div class="row">
                    <div class="col p-3">
                        <div class="d-flex text-center justify-content-center align-items-center">
                            <p class="copyright pb-0 mb-0">Copyrights © <?php echo date('Y');?>. All
                                rights reserved by
    ...
    <script src="<?php echo base_url('Assets/');?>js/vendors/mixitup.min.js"></script>
    <script src="<?php echo base_url('Assets/');?>js/vendors/headroom.min.js"></script>
    <script src="<?php echo base_url('Assets/');?>js/vendors/smooth-scroll.min.js"></script>
    ...
    <script src="<?php echo base_url('Assets/');?>js/vendors/jquery.waypoints.min.js"></script>
    <!--<script src="<?php echo base_url('Assets/');?>js/vendors/countUp.min.js"></script>-->
...
<!-- Mirrored from corporx.themetags.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Mar 2021 10:36:40 GMT -->
</html>