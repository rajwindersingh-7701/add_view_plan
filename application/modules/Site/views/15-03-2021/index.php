...
?>
    ...
    <div class="main">
        ...
        <!--hero section start-->
        <section class="section pt-9 pb-9 section-header text-white gradient-overly-right-color" style="background: url('Assets/img/hero-bg10.jpg')no-repeat center center / cover">
            <div class="container">
                <div class="row">
