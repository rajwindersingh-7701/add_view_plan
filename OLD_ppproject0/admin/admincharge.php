...
<head>
    ...
    <title>Super Digital Coin  - Admin</title>
...
<script>function exportF(elem) {
  ...
  elem.setAttribute("download", "admincharge<?php echo date('d-m-Y');?>.xls"); // Choose the file name
  return false;
}</script></head>
                ...
                <div class="row">
                	<div class="col-lg-12">
                        ...
                        <form action="" method="post"><table width="100%">
                           ...
                           <a id="downloadLink" onclick="exportF(this)"><button value="Export to excel" >Export to excel</button></a><br><br>                           <?php if($_POST['submit']==''){?>
                        	...
                        	<table class="table table-bordered table-striped" id="table">
								...
								echo $tgt=$gt_r['0'];
								?></td>
                                <td colspan="2" style="float:left"><?php $gtt=mysqli_query($con,"select sum(adm_amt) from withdrwal where status='Success' ");
								...
								$query = mysqli_query($con,"select * from withdrwal where r_date between '".$_POST['fromdate']."' and '".$_POST['todate']."' and status='Success' order by id");
                            ...
                            <table class="table table-bordered table-striped" id="table">
								...
								echo $tgt=$gt_r['0'];
								?></td>
                                <td colspan="2" style="float:left"><?php $gtt=mysqli_query($con,"select sum(adm_amt) from withdrwal where r_date between '".$_POST['fromdate']."' and '".$_POST['todate']."' and status='Success' ");
								$gtt_r=mysqli_fetch_array($gtt);
								echo $tgtt=$gtt_r['0'];
								?></td>
                                </tr>
