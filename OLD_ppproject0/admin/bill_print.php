        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <div id='printMe'><div class="book">
                        <?php $bl=mysqli_query($con,"select * from user where act_date between '".$_POST['fromdate']."' and '".$_POST['todate']."' and  status='Active' order by ex_date");
  ...
  <div class="page">
    <div class="subpage">    
                  ...
                  <table class="table table-bordered table-striped" >
                    <?php 
									   $pn=mysqli_query($con,"select * from pin_list where use_for='".$bl_r['loginid']."'");
									          $pn_r=mysqli_fetch_array($pn);
									   ?>
                    <tr><th colspan="8"><center><h3>Super Digital Coin Private Limited</h3></center></th></tr>
                    <tr><th colspan="4">Invoice No. 000<?php $ba=mysqli_query($con,"select * from j_bill where user_id='".$bl_r['loginid']."'");
					$ba_r=mysqli_fetch_array($ba);
					 echo $ba_r['id'];?></th>
    ...
    <tr>
                                    ...
                                    <th colspan="2">Total Amount</th>
                                       ...
                                       <?php   $us=mysqli_query($con,"select * from user where loginid='".$bl_r['loginid']."'");
                    ...
                    <?php }?>
                                    <tr><th colspan="6">Total Amount:</th>
                    <th colspan="2">Rs. <?php echo $pn_r['pintype'];?>.00/-</th>
                    </tr><?php }elseif($pn_r['pintype']=='650'){?>
                    <td>1</td>
                                    <td>Sanitary Pads</td>
                                    <td>96190010</td>
                                    <td>1</td>
