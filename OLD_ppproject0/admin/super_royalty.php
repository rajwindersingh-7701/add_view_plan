 ...
 <?php include('php-includes/menu.php'); ?>
   <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Super Royalty Achivers</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                	...
                	<div class="col-lg-12">
                    	<div class="table-responsive">
                        	...
                        	<table class="table table-striped table-bordered"  id="table">
                                ...
                                <?php $bl=mysqli_query($con,"select * from royalty_super order by id");
								$i=0;
								...
								?>
                                    	<tr>
                                            ...
                                            <td><?php $tl=mysqli_query($con,"select sum(amount) from royalty where user_id='".$bl_r['user_id']."'");
