...
<body>
    ...
    <div id="wrapper">
        ...
        // Import the file where we defined the connection to Database.     
            ...
            $query = "SELECT * FROM level_in LIMIT $start_from, $per_page_record";     
        ...
        <?php     $i=0;
         ...
         <div class="pagination">    
          <?php  
            $query = "SELECT COUNT(*) FROM level_in";     
            $rs_result = mysqli_query($con, $query);     
        ...
        echo "</br>";     
            ...
            if($page>=2){   
                echo "<a href='page.php?page=".($page-1)."'>  Prev </a>";   
            }       
                       
            for ($i=1; $i<=$total_pages; $i++) {   
              if ($i == $page) {   
                  $pagLink .= "<a class = 'active' href='page.php?page="  
                                                    .$i."'>".$i." </a>";   
              }               
              else  {   
                  $pagLink .= "<a href='page.php?page=".$i."'>   
                                                    ".$i." </a>";     
              }   
            };     
            echo $pagLink;   
