...
<head>
    ...
    <title>Super Digital Coin - Reject</title>
 ...
 <?php include('php-includes/menu.php'); ?>
   <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Reject</h1>
                	...
                	<div class="col-lg-12">
                        ...
                        <a id="downloadLink" onclick="exportF(this)"><button value="Export to excel" >Export to excel</button></a>
                            ...
                            <table class="table table-striped table-bordered"  id="table">
                                ...
                                <?php
									$query = mysqli_query($con,"select * from req_payment where r_status='Reject' order by id");
									...
									?>
                                    	<tr>
                                        	<td colspan="6" align="center">You have no data.</td>
                                        </tr>
                                    <?php }?>
                            </table>
